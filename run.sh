export PROJECT_HOME="/ds1/pdi/vtop/HRIT/cb_candidates_dummy/cb_candidates_dummy/PDI/Common"
...
export LOG_DIR="/ds1/pdi/data/CB/log/cb_candidates_dummy"
...
log_ext='.log'
log_file=${LOG_DIR}/$file_folder_name/'cb_candidates_dummy-'$log_date$log_ext
...
if  [ $ce -gt 0 ]; then
  ...
  } | mailx -s $host_name' - CB cb_candidates_dummy PDI Process - ' -r noreply@kuehne-nagel.com amer.hrit.support@kuehne-nagel.com
fi